...
import { removeMechanization, saveMechanization } from '@fetchers'
...
const EditSection: FC<EditSectionProps> = (props) => {
    ...
    const { name, label, capacity, price, order, type, pictures } = props.data
    ...
    const update: SubmitHandler<EditSectionInputs> = async (data) => {
        ...
        const response = await saveMechanization(mechanizationObject)
